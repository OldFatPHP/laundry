...
function navClick1(x) {
    ...
    //控制模块切换
    if (x == "Server1") {
        document.getElementById("ServerDiv").src = "http://localhost/laundry/index.php/Index/Order/topClothes";
    }
    else if (x == "Server2") {
        document.getElementById("ServerDiv").src = "http://localhost/laundry/index.php/Index/Order/shoes";
    }
    else if (x == "Server3") {
        document.getElementById("ServerDiv").src = "http://localhost/laundry/index.php/Index/Order/homeFurnishing";
    }
    else if (x == "Server4") {
        document.getElementById("ServerDiv").src = "http://localhost/laundry/index.php/Index/Order/luxury";
    }
