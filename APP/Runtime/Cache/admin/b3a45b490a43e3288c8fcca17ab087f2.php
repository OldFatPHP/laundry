...
<div style="margin-left:10;">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 订单管理 <span class="c-gray en">&gt;</span> 待派送订单列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<?php if(is_array($order)): foreach($order as $key=>$vo): ?><tr class="text-c va-m">
						...
						<td><a href="<?php echo U(GROUP_NAME . '/Order/showFeedback', array('orderId'=>$vo['orderId']));?>" title="点击查看反馈内容">已反馈</a> </td>
						<td class="td-status"><span class="label label-success radius">待派件</span></td>
						<td class="td-manage"><a href="<?php echo U('send',array('id' => $vo['orderId']));?>" class="btn btn-sm btn-link" onClick="return rec()">已派件</a></td>
