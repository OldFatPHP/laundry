...
<article class="page-container">
	<form class="form form-horizontal" method="post" action="<?php echo U(GROUP_NAME . '/Product/productAdd');?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="产品名称" id="" name="productName" required>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>缩略图：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="请将产品数据提交后再上传图片" readonly/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>类别：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<?php if($productUid == 1): ?><select name="productUid" class="select">
						<option value="1" selected>衣服类</option>
						<option value="2" >鞋类</option>
						<option value="3" >家具用品类</option>
						<option value="4" >奢侈品护理</option>
					</select>
				<?php elseif($productUid == 2): ?>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="产品描述" id="" name="productDetail" required>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>单价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="产品单价" id="" name="productPrice" required>
			</div>
		</div>
		<div class="row cl">
