...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<?php echo U('Order/feedBack');?>" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">反馈内容：<br/>(图片大小限制500kb)</label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" type="text/plain" style="width:100%;height:400px;" name="orderFeedbackContent"></script>
			</div>
		</div>
		<div class="row cl">
