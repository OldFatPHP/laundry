...
<div style="margin-left:0;">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 积分及优惠活动 <span class="c-gray en">&gt;</span> 优惠券管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<!-- <div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius" href="<?php echo U(GROUP_NAME . '/Coupon/couponAddPage');?>"><i class="Hui-iconfont">&#xe600;</i> 添加优惠券</a></span></div>
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<?php if(is_array($couponData)): $i = 0; $__LIST__ = $couponData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$couponDataVo): $mod = ($i % 2 );++$i;?><tr class="text-c va-m">
						<td><?php echo ($couponDataVo["couponName"]); ?></td>
