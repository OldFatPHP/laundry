...
<article class="page-container">
	<form class="form form-horizontal" method="post" action="<?php echo U(GROUP_NAME . '/System/adminEdit');?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>账号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($adminData["adminName"]); ?>" placeholder="账号" id="" name="adminName" required>
				<input type="hidden" name="adminId" value="<?php echo ($adminData["adminId"]); ?>"/>
			</div>
		</div>
		<div class="row cl">
